...
char *vulture_basename(char *filename)
{
...
void vulture_write_log_va(int msgtype, char *file, int line, const char *logmessage, va_list args)
{
	FILE *f = NULL;
...
void vulture_write_log(int msgtype, char *file, int line, const char *logmessage, ...)
{
	va_list args;
...
void vulture_oom(int do_exit, char *file, int line)
{
