...
eraseoldlocks()
{
	...
	/* jtp_write_log_message("DEBUG: eraseoldlocks(), step 1\n"); */
...
/*  jtp_write_log_message("DEBUG: getlock(), step 1\n"); */
...
/*  jtp_write_log_message("DEBUG: getlock(), step 2\n"); */
...
/*  jtp_write_log_message("DEBUG: getlock(), step 6\n"); */

# if defined(MSDOS) && defined(NO_TERMS)
	if (grmode) gr_init();
# endif

/*  jtp_write_log_message("DEBUG: Exited getlock()\n"); */
}	
#endif /* PC_LOCKING */
