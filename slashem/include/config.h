...
#ifdef MSDOS
# define JTP_GRAPHICS /* Vulture's Eye isometric graphics interface */
#endif
#ifdef WIN32
# define JTP_GRAPHICS /* Vulture's Eye isometric graphics interface */
#endif
 ...
 *
 *	tty, X11, mac, amii, BeOS, Qt, Gem, Gnome, gtk, proxy, GL, SDL, Vulture's Eye (jtp)
 */
...
#define JTP_USE_AS_DEFAULT /* Use Vulture's Eye as the default window port */

#ifdef JTP_GRAPHICS
/* 
 * If there's no default window port yet, 
 * make Vulture's Eye the default 
 */
# ifndef DEFAULT_WINDOW_SYS
#  define DEFAULT_WINDOW_SYS "jtp"
# endif
/* 
 * Should we force Vulture's Eye to be the default?
