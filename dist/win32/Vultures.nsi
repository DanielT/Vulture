...
Section "Start Menu Shortcuts"
  ...
  CreateShortCut "$SMPROGRAMS\Vulture's\Play Vulture's Eye.lnk" "$INSTDIR\Eye\VulturesEye.exe" "" "$INSTDIR\VulturesEye.exe" 0
  CreateShortCut "$SMPROGRAMS\Vulture's\Play Vulture's Claw.lnk" "$INSTDIR\Claw\VulturesClaw.exe" "" "$INSTDIR\VulturesClaw.exe" 0
