...
#define V_FILENAME_FONT_SMALL           "VeraSe.ttf"
#define V_FILENAME_FONT_LARGE           "VeraSe.ttf"
...
extern struct window * vultures_create_window_internal(int nh_type, struct window * parent, int wintype);
